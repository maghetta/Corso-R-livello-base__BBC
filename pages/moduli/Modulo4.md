...
<br>
I pacchetti di R disponibili dal *CRAN* per essere installati sul proprio PC sono elencati [qui](https://cloud.r-project.org/web/packages/available_packages_by_name.html).
